...
/**
 * Created by vreee on 27/03/2018.
 */
...
public class LocationUpdatesService extends Service {
    ...
    private static final String PACKAGE_NAME =
            "com.example.vreeni.StreetMovementApp";
    ...
    public boolean onUnbind(Intent intent) {
        ...
        if (!mChangingConfiguration && Utils.requestingLocationUpdates(this)) {
            ...
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.O) {
                ...
                Log.d(TAG, "targeting oreo, creating notification channel");
                startForeground(NOTIFICATION_ID, getNotification());
                Log.d(TAG, "oreo foreground service started");

//                mNotificationManager.startServiceInForeground(new Intent(this,
//                        LocationUpdatesService.class), NOTIFICATION_ID, getNotification());
            } else {
                startForeground(NOTIFICATION_ID, getNotification());
                Log.d(TAG, "not targetting oreo, creating notification updates");
            }
            startForeground(NOTIFICATION_ID, getNotification());
