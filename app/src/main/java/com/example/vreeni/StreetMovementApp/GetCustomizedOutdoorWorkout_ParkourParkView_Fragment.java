...
public class GetCustomizedOutdoorWorkout_ParkourParkView_Fragment extends Fragment implements View.OnClickListener {
    private String TAG = "GetCustOW_PkParkView_Fragment: ";
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        TextView tv_name = (TextView) view.findViewById(R.id.tv_parkourpark_name);
        TextView tv_description = (TextView) view.findViewById(R.id.tv_parkourpark_description);
        ...
        if (outdoorBundle != null) {
            pk = outdoorBundle.getParcelable("OutdoorWorkout");
